...
#define THREAD_BVADDR 868 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 872 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 876 /* offsetof(struct task_struct, thread.error_code)	 # */
...
#define VCPU_ARCH_SIZE 6448 /* sizeof(struct kvm_vcpu_arch)	 # */
...
#define VCPU_GUEST_KERNEL_ASID 1512 /* offsetof(struct kvm_vcpu_arch, guest_kernel_asid)	 # */
