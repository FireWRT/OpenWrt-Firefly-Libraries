 ...
 # GNU C (OpenWrt/Linaro GCC 4.8-2014.04 r45583) version 4.8.3 (mipsel-openwrt-linux-uclibc)
 ...
 # -idirafter /home/wbj/project/mt7621/firewrt_build_all_app/FireWRT-OpenWrt-Firefly-FireWRT-SDK/staging_dir/target-mipsel_1004kc+dsp_uClibc-0.9.33.2/usr/include
 ...
 # -isystem /home/wbj/project/mt7621/firewrt_build_all_app/FireWRT-OpenWrt-Firefly-FireWRT-SDK/staging_dir/toolchain-mipsel_1004kc+dsp_gcc-4.8-linaro_uClibc-0.9.33.2/lib/gcc/mipsel-openwrt-linux-uclibc/4.8.3/include
...
->TASK_MM 388 offsetof(struct task_struct, mm)	 #
 # 0 "" 2
	.loc 1 83 0
 # 83 "arch/mips/kernel/asm-offsets.c" 1
	
->TASK_PID 464 offsetof(struct task_struct, pid)	 #
 # 0 "" 2
	.loc 1 87 0
 # 87 "arch/mips/kernel/asm-offsets.c" 1
	
->TASK_STRUCT_SIZE 1360 sizeof(struct task_struct)	 #
 # 0 "" 2
	.loc 1 88 0
...
->THREAD_REG16 728 offsetof(struct task_struct, thread.reg16)	 #
 # 0 "" 2
	.loc 1 112 0
 # 112 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG17 732 offsetof(struct task_struct, thread.reg17)	 #
 # 0 "" 2
	.loc 1 113 0
 # 113 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG18 736 offsetof(struct task_struct, thread.reg18)	 #
 # 0 "" 2
	.loc 1 114 0
 # 114 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG19 740 offsetof(struct task_struct, thread.reg19)	 #
 # 0 "" 2
	.loc 1 115 0
 # 115 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG20 744 offsetof(struct task_struct, thread.reg20)	 #
 # 0 "" 2
	.loc 1 116 0
 # 116 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG21 748 offsetof(struct task_struct, thread.reg21)	 #
 # 0 "" 2
	.loc 1 117 0
 # 117 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG22 752 offsetof(struct task_struct, thread.reg22)	 #
 # 0 "" 2
	.loc 1 118 0
 # 118 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG23 756 offsetof(struct task_struct, thread.reg23)	 #
 # 0 "" 2
	.loc 1 119 0
 # 119 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG29 760 offsetof(struct task_struct, thread.reg29)	 #
 # 0 "" 2
	.loc 1 120 0
 # 120 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG30 764 offsetof(struct task_struct, thread.reg30)	 #
 # 0 "" 2
	.loc 1 121 0
 # 121 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_REG31 768 offsetof(struct task_struct, thread.reg31)	 #
 # 0 "" 2
	.loc 1 122 0
 # 122 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_STATUS 772 offsetof(struct task_struct, thread.cp0_status)	 #
 # 0 "" 2
	.loc 1 124 0
 # 124 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPU 776 offsetof(struct task_struct, thread.fpu)	 #
 # 0 "" 2
	.loc 1 126 0
 # 126 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_BVADDR 1100 offsetof(struct task_struct, thread.cp0_badvaddr)	 #
 # 0 "" 2
	.loc 1 128 0
 # 128 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_BUADDR 1104 offsetof(struct task_struct, thread.cp0_baduaddr)	 #
 # 0 "" 2
	.loc 1 130 0
 # 130 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_ECODE 1108 offsetof(struct task_struct, thread.error_code)	 #
 # 0 "" 2
	.loc 1 132 0
...
->THREAD_FPR0 776 offsetof(struct task_struct, thread.fpu.fpr[0])	 #
 # 0 "" 2
	.loc 1 138 0
 # 138 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR1 784 offsetof(struct task_struct, thread.fpu.fpr[1])	 #
 # 0 "" 2
	.loc 1 139 0
 # 139 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR2 792 offsetof(struct task_struct, thread.fpu.fpr[2])	 #
 # 0 "" 2
	.loc 1 140 0
 # 140 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR3 800 offsetof(struct task_struct, thread.fpu.fpr[3])	 #
 # 0 "" 2
	.loc 1 141 0
 # 141 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR4 808 offsetof(struct task_struct, thread.fpu.fpr[4])	 #
 # 0 "" 2
	.loc 1 142 0
 # 142 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR5 816 offsetof(struct task_struct, thread.fpu.fpr[5])	 #
 # 0 "" 2
	.loc 1 143 0
 # 143 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR6 824 offsetof(struct task_struct, thread.fpu.fpr[6])	 #
 # 0 "" 2
	.loc 1 144 0
 # 144 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR7 832 offsetof(struct task_struct, thread.fpu.fpr[7])	 #
 # 0 "" 2
	.loc 1 145 0
 # 145 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR8 840 offsetof(struct task_struct, thread.fpu.fpr[8])	 #
 # 0 "" 2
	.loc 1 146 0
 # 146 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR9 848 offsetof(struct task_struct, thread.fpu.fpr[9])	 #
 # 0 "" 2
	.loc 1 147 0
 # 147 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR10 856 offsetof(struct task_struct, thread.fpu.fpr[10])	 #
 # 0 "" 2
	.loc 1 148 0
 # 148 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR11 864 offsetof(struct task_struct, thread.fpu.fpr[11])	 #
 # 0 "" 2
	.loc 1 149 0
 # 149 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR12 872 offsetof(struct task_struct, thread.fpu.fpr[12])	 #
 # 0 "" 2
	.loc 1 150 0
 # 150 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR13 880 offsetof(struct task_struct, thread.fpu.fpr[13])	 #
 # 0 "" 2
	.loc 1 151 0
 # 151 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR14 888 offsetof(struct task_struct, thread.fpu.fpr[14])	 #
 # 0 "" 2
	.loc 1 152 0
 # 152 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR15 896 offsetof(struct task_struct, thread.fpu.fpr[15])	 #
 # 0 "" 2
	.loc 1 153 0
 # 153 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR16 904 offsetof(struct task_struct, thread.fpu.fpr[16])	 #
 # 0 "" 2
	.loc 1 154 0
 # 154 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR17 912 offsetof(struct task_struct, thread.fpu.fpr[17])	 #
 # 0 "" 2
	.loc 1 155 0
 # 155 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR18 920 offsetof(struct task_struct, thread.fpu.fpr[18])	 #
 # 0 "" 2
	.loc 1 156 0
 # 156 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR19 928 offsetof(struct task_struct, thread.fpu.fpr[19])	 #
 # 0 "" 2
	.loc 1 157 0
 # 157 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR20 936 offsetof(struct task_struct, thread.fpu.fpr[20])	 #
 # 0 "" 2
	.loc 1 158 0
 # 158 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR21 944 offsetof(struct task_struct, thread.fpu.fpr[21])	 #
 # 0 "" 2
	.loc 1 159 0
 # 159 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR22 952 offsetof(struct task_struct, thread.fpu.fpr[22])	 #
 # 0 "" 2
	.loc 1 160 0
 # 160 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR23 960 offsetof(struct task_struct, thread.fpu.fpr[23])	 #
 # 0 "" 2
	.loc 1 161 0
 # 161 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR24 968 offsetof(struct task_struct, thread.fpu.fpr[24])	 #
 # 0 "" 2
	.loc 1 162 0
 # 162 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR25 976 offsetof(struct task_struct, thread.fpu.fpr[25])	 #
 # 0 "" 2
	.loc 1 163 0
 # 163 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR26 984 offsetof(struct task_struct, thread.fpu.fpr[26])	 #
 # 0 "" 2
	.loc 1 164 0
 # 164 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR27 992 offsetof(struct task_struct, thread.fpu.fpr[27])	 #
 # 0 "" 2
	.loc 1 165 0
 # 165 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR28 1000 offsetof(struct task_struct, thread.fpu.fpr[28])	 #
 # 0 "" 2
	.loc 1 166 0
 # 166 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR29 1008 offsetof(struct task_struct, thread.fpu.fpr[29])	 #
 # 0 "" 2
	.loc 1 167 0
 # 167 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR30 1016 offsetof(struct task_struct, thread.fpu.fpr[30])	 #
 # 0 "" 2
	.loc 1 168 0
 # 168 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR31 1024 offsetof(struct task_struct, thread.fpu.fpr[31])	 #
 # 0 "" 2
	.loc 1 171 0
 # 171 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR0_LS64 776 offsetof(struct task_struct, thread.fpu.fpr[0].val64[(0)])	 #
 # 0 "" 2
	.loc 1 173 0
 # 173 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR1_LS64 784 offsetof(struct task_struct, thread.fpu.fpr[1].val64[(0)])	 #
 # 0 "" 2
	.loc 1 175 0
 # 175 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR2_LS64 792 offsetof(struct task_struct, thread.fpu.fpr[2].val64[(0)])	 #
 # 0 "" 2
	.loc 1 177 0
 # 177 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR3_LS64 800 offsetof(struct task_struct, thread.fpu.fpr[3].val64[(0)])	 #
 # 0 "" 2
	.loc 1 179 0
 # 179 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR4_LS64 808 offsetof(struct task_struct, thread.fpu.fpr[4].val64[(0)])	 #
 # 0 "" 2
	.loc 1 181 0
 # 181 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR5_LS64 816 offsetof(struct task_struct, thread.fpu.fpr[5].val64[(0)])	 #
 # 0 "" 2
	.loc 1 183 0
 # 183 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR6_LS64 824 offsetof(struct task_struct, thread.fpu.fpr[6].val64[(0)])	 #
 # 0 "" 2
	.loc 1 185 0
 # 185 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR7_LS64 832 offsetof(struct task_struct, thread.fpu.fpr[7].val64[(0)])	 #
 # 0 "" 2
	.loc 1 187 0
 # 187 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR8_LS64 840 offsetof(struct task_struct, thread.fpu.fpr[8].val64[(0)])	 #
 # 0 "" 2
	.loc 1 189 0
 # 189 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR9_LS64 848 offsetof(struct task_struct, thread.fpu.fpr[9].val64[(0)])	 #
 # 0 "" 2
	.loc 1 191 0
 # 191 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR10_LS64 856 offsetof(struct task_struct, thread.fpu.fpr[10].val64[(0)])	 #
 # 0 "" 2
	.loc 1 193 0
 # 193 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR11_LS64 864 offsetof(struct task_struct, thread.fpu.fpr[11].val64[(0)])	 #
 # 0 "" 2
	.loc 1 195 0
 # 195 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR12_LS64 872 offsetof(struct task_struct, thread.fpu.fpr[12].val64[(0)])	 #
 # 0 "" 2
	.loc 1 197 0
 # 197 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR13_LS64 880 offsetof(struct task_struct, thread.fpu.fpr[13].val64[(0)])	 #
 # 0 "" 2
	.loc 1 199 0
 # 199 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR14_LS64 888 offsetof(struct task_struct, thread.fpu.fpr[14].val64[(0)])	 #
 # 0 "" 2
	.loc 1 201 0
 # 201 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR15_LS64 896 offsetof(struct task_struct, thread.fpu.fpr[15].val64[(0)])	 #
 # 0 "" 2
	.loc 1 203 0
 # 203 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR16_LS64 904 offsetof(struct task_struct, thread.fpu.fpr[16].val64[(0)])	 #
 # 0 "" 2
	.loc 1 205 0
 # 205 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR17_LS64 912 offsetof(struct task_struct, thread.fpu.fpr[17].val64[(0)])	 #
 # 0 "" 2
	.loc 1 207 0
 # 207 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR18_LS64 920 offsetof(struct task_struct, thread.fpu.fpr[18].val64[(0)])	 #
 # 0 "" 2
	.loc 1 209 0
 # 209 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR19_LS64 928 offsetof(struct task_struct, thread.fpu.fpr[19].val64[(0)])	 #
 # 0 "" 2
	.loc 1 211 0
 # 211 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR20_LS64 936 offsetof(struct task_struct, thread.fpu.fpr[20].val64[(0)])	 #
 # 0 "" 2
	.loc 1 213 0
 # 213 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR21_LS64 944 offsetof(struct task_struct, thread.fpu.fpr[21].val64[(0)])	 #
 # 0 "" 2
	.loc 1 215 0
 # 215 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR22_LS64 952 offsetof(struct task_struct, thread.fpu.fpr[22].val64[(0)])	 #
 # 0 "" 2
	.loc 1 217 0
 # 217 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR23_LS64 960 offsetof(struct task_struct, thread.fpu.fpr[23].val64[(0)])	 #
 # 0 "" 2
	.loc 1 219 0
 # 219 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR24_LS64 968 offsetof(struct task_struct, thread.fpu.fpr[24].val64[(0)])	 #
 # 0 "" 2
	.loc 1 221 0
 # 221 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR25_LS64 976 offsetof(struct task_struct, thread.fpu.fpr[25].val64[(0)])	 #
 # 0 "" 2
	.loc 1 223 0
 # 223 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR26_LS64 984 offsetof(struct task_struct, thread.fpu.fpr[26].val64[(0)])	 #
 # 0 "" 2
	.loc 1 225 0
 # 225 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR27_LS64 992 offsetof(struct task_struct, thread.fpu.fpr[27].val64[(0)])	 #
 # 0 "" 2
	.loc 1 227 0
 # 227 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR28_LS64 1000 offsetof(struct task_struct, thread.fpu.fpr[28].val64[(0)])	 #
 # 0 "" 2
	.loc 1 229 0
 # 229 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR29_LS64 1008 offsetof(struct task_struct, thread.fpu.fpr[29].val64[(0)])	 #
 # 0 "" 2
	.loc 1 231 0
 # 231 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR30_LS64 1016 offsetof(struct task_struct, thread.fpu.fpr[30].val64[(0)])	 #
 # 0 "" 2
	.loc 1 233 0
 # 233 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FPR31_LS64 1024 offsetof(struct task_struct, thread.fpu.fpr[31].val64[(0)])	 #
 # 0 "" 2
	.loc 1 236 0
 # 236 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_FCR31 1032 offsetof(struct task_struct, thread.fpu.fcr31)	 #
 # 0 "" 2
	.loc 1 237 0
 # 237 "arch/mips/kernel/asm-offsets.c" 1
	
->THREAD_MSA_CSR 1036 offsetof(struct task_struct, thread.fpu.msacsr)	 #
 # 0 "" 2
	.loc 1 238 0
...
->VCPU_ARCH_SIZE 2400 sizeof(struct kvm_vcpu_arch)	 #
 # 0 "" 2
	.loc 1 421 0
 # 421 "arch/mips/kernel/asm-offsets.c" 1
	
->VCPU_RUN 44 offsetof(struct kvm_vcpu, run)	 #
 # 0 "" 2
	.loc 1 422 0
 # 422 "arch/mips/kernel/asm-offsets.c" 1
	
->VCPU_HOST_ARCH 216 offsetof(struct kvm_vcpu, arch)	 #
 # 0 "" 2
	.loc 1 424 0
...
$Letext0:
	...
	.file 3 "include/linux/cpumask.h"
	...
	.file 11 "./arch/mips/include/asm/mips-cm.h"
	.file 12 "./arch/mips/include/asm/smp.h"
	.file 13 "./arch/mips/include/asm/smp-ops.h"
	.file 14 "include/linux/highuid.h"
	.file 15 "include/linux/seq_file.h"
	.file 16 "include/linux/sched.h"
	.file 17 "include/asm-generic/percpu.h"
	.file 18 "include/linux/mmzone.h"
	.file 19 "include/linux/timekeeping.h"
	.file 20 "include/linux/workqueue.h"
	.file 21 "include/linux/percpu_counter.h"
	.file 22 "include/linux/debug_locks.h"
	.file 23 "./arch/mips/include/asm/pgtable-32.h"
	.file 24 "./arch/mips/include/asm/pgtable.h"
	.file 25 "include/asm-generic/pgtable.h"
	.file 26 "include/linux/vmstat.h"
	.file 27 "include/linux/dcache.h"
	.file 28 "include/linux/quota.h"
	.file 29 "include/linux/jump_label.h"
	.file 30 "include/linux/ioport.h"
	.file 31 "include/linux/swap.h"
	.file 32 "include/linux/suspend.h"
	.file 33 "include/linux/slab.h"
	.file 34 "include/linux/interrupt.h"
...
$LASF88:
	.ascii	"/home/wbj/project/mt7621/firewrt_build_all_app/FireWRT-O"
	.ascii	"penWrt-Firefly-FireWRT-SDK/build_dir/target-mipsel_1004k"
	.ascii	"c+dsp_uClibc-0.9.33.2/linux-ramips_mt7621/linux-3.18.11\000"
$LASF22:
...
$LASF43:
	...
	.ident	"GCC: (OpenWrt/Linaro GCC 4.8-2014.04 r45583) 4.8.3"
