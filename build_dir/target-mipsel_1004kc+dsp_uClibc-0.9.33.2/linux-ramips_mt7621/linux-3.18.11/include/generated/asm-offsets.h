...
#define TASK_MM 388 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 464 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STRUCT_SIZE 1360 /* sizeof(struct task_struct)	 # */
...
#define THREAD_REG16 728 /* offsetof(struct task_struct, thread.reg16)	 # */
#define THREAD_REG17 732 /* offsetof(struct task_struct, thread.reg17)	 # */
#define THREAD_REG18 736 /* offsetof(struct task_struct, thread.reg18)	 # */
#define THREAD_REG19 740 /* offsetof(struct task_struct, thread.reg19)	 # */
#define THREAD_REG20 744 /* offsetof(struct task_struct, thread.reg20)	 # */
#define THREAD_REG21 748 /* offsetof(struct task_struct, thread.reg21)	 # */
#define THREAD_REG22 752 /* offsetof(struct task_struct, thread.reg22)	 # */
#define THREAD_REG23 756 /* offsetof(struct task_struct, thread.reg23)	 # */
#define THREAD_REG29 760 /* offsetof(struct task_struct, thread.reg29)	 # */
#define THREAD_REG30 764 /* offsetof(struct task_struct, thread.reg30)	 # */
#define THREAD_REG31 768 /* offsetof(struct task_struct, thread.reg31)	 # */
#define THREAD_STATUS 772 /* offsetof(struct task_struct, thread.cp0_status)	 # */
#define THREAD_FPU 776 /* offsetof(struct task_struct, thread.fpu)	 # */
#define THREAD_BVADDR 1100 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 1104 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 1108 /* offsetof(struct task_struct, thread.error_code)	 # */

#define THREAD_FPR0 776 /* offsetof(struct task_struct, thread.fpu.fpr[0])	 # */
#define THREAD_FPR1 784 /* offsetof(struct task_struct, thread.fpu.fpr[1])	 # */
#define THREAD_FPR2 792 /* offsetof(struct task_struct, thread.fpu.fpr[2])	 # */
#define THREAD_FPR3 800 /* offsetof(struct task_struct, thread.fpu.fpr[3])	 # */
#define THREAD_FPR4 808 /* offsetof(struct task_struct, thread.fpu.fpr[4])	 # */
#define THREAD_FPR5 816 /* offsetof(struct task_struct, thread.fpu.fpr[5])	 # */
#define THREAD_FPR6 824 /* offsetof(struct task_struct, thread.fpu.fpr[6])	 # */
#define THREAD_FPR7 832 /* offsetof(struct task_struct, thread.fpu.fpr[7])	 # */
#define THREAD_FPR8 840 /* offsetof(struct task_struct, thread.fpu.fpr[8])	 # */
#define THREAD_FPR9 848 /* offsetof(struct task_struct, thread.fpu.fpr[9])	 # */
#define THREAD_FPR10 856 /* offsetof(struct task_struct, thread.fpu.fpr[10])	 # */
#define THREAD_FPR11 864 /* offsetof(struct task_struct, thread.fpu.fpr[11])	 # */
#define THREAD_FPR12 872 /* offsetof(struct task_struct, thread.fpu.fpr[12])	 # */
#define THREAD_FPR13 880 /* offsetof(struct task_struct, thread.fpu.fpr[13])	 # */
#define THREAD_FPR14 888 /* offsetof(struct task_struct, thread.fpu.fpr[14])	 # */
#define THREAD_FPR15 896 /* offsetof(struct task_struct, thread.fpu.fpr[15])	 # */
#define THREAD_FPR16 904 /* offsetof(struct task_struct, thread.fpu.fpr[16])	 # */
#define THREAD_FPR17 912 /* offsetof(struct task_struct, thread.fpu.fpr[17])	 # */
#define THREAD_FPR18 920 /* offsetof(struct task_struct, thread.fpu.fpr[18])	 # */
#define THREAD_FPR19 928 /* offsetof(struct task_struct, thread.fpu.fpr[19])	 # */
#define THREAD_FPR20 936 /* offsetof(struct task_struct, thread.fpu.fpr[20])	 # */
#define THREAD_FPR21 944 /* offsetof(struct task_struct, thread.fpu.fpr[21])	 # */
#define THREAD_FPR22 952 /* offsetof(struct task_struct, thread.fpu.fpr[22])	 # */
#define THREAD_FPR23 960 /* offsetof(struct task_struct, thread.fpu.fpr[23])	 # */
#define THREAD_FPR24 968 /* offsetof(struct task_struct, thread.fpu.fpr[24])	 # */
#define THREAD_FPR25 976 /* offsetof(struct task_struct, thread.fpu.fpr[25])	 # */
#define THREAD_FPR26 984 /* offsetof(struct task_struct, thread.fpu.fpr[26])	 # */
#define THREAD_FPR27 992 /* offsetof(struct task_struct, thread.fpu.fpr[27])	 # */
#define THREAD_FPR28 1000 /* offsetof(struct task_struct, thread.fpu.fpr[28])	 # */
#define THREAD_FPR29 1008 /* offsetof(struct task_struct, thread.fpu.fpr[29])	 # */
#define THREAD_FPR30 1016 /* offsetof(struct task_struct, thread.fpu.fpr[30])	 # */
#define THREAD_FPR31 1024 /* offsetof(struct task_struct, thread.fpu.fpr[31])	 # */
#define THREAD_FPR0_LS64 776 /* offsetof(struct task_struct, thread.fpu.fpr[0].val64[(0)])	 # */
#define THREAD_FPR1_LS64 784 /* offsetof(struct task_struct, thread.fpu.fpr[1].val64[(0)])	 # */
#define THREAD_FPR2_LS64 792 /* offsetof(struct task_struct, thread.fpu.fpr[2].val64[(0)])	 # */
#define THREAD_FPR3_LS64 800 /* offsetof(struct task_struct, thread.fpu.fpr[3].val64[(0)])	 # */
#define THREAD_FPR4_LS64 808 /* offsetof(struct task_struct, thread.fpu.fpr[4].val64[(0)])	 # */
#define THREAD_FPR5_LS64 816 /* offsetof(struct task_struct, thread.fpu.fpr[5].val64[(0)])	 # */
#define THREAD_FPR6_LS64 824 /* offsetof(struct task_struct, thread.fpu.fpr[6].val64[(0)])	 # */
#define THREAD_FPR7_LS64 832 /* offsetof(struct task_struct, thread.fpu.fpr[7].val64[(0)])	 # */
#define THREAD_FPR8_LS64 840 /* offsetof(struct task_struct, thread.fpu.fpr[8].val64[(0)])	 # */
#define THREAD_FPR9_LS64 848 /* offsetof(struct task_struct, thread.fpu.fpr[9].val64[(0)])	 # */
#define THREAD_FPR10_LS64 856 /* offsetof(struct task_struct, thread.fpu.fpr[10].val64[(0)])	 # */
#define THREAD_FPR11_LS64 864 /* offsetof(struct task_struct, thread.fpu.fpr[11].val64[(0)])	 # */
#define THREAD_FPR12_LS64 872 /* offsetof(struct task_struct, thread.fpu.fpr[12].val64[(0)])	 # */
#define THREAD_FPR13_LS64 880 /* offsetof(struct task_struct, thread.fpu.fpr[13].val64[(0)])	 # */
#define THREAD_FPR14_LS64 888 /* offsetof(struct task_struct, thread.fpu.fpr[14].val64[(0)])	 # */
#define THREAD_FPR15_LS64 896 /* offsetof(struct task_struct, thread.fpu.fpr[15].val64[(0)])	 # */
#define THREAD_FPR16_LS64 904 /* offsetof(struct task_struct, thread.fpu.fpr[16].val64[(0)])	 # */
#define THREAD_FPR17_LS64 912 /* offsetof(struct task_struct, thread.fpu.fpr[17].val64[(0)])	 # */
#define THREAD_FPR18_LS64 920 /* offsetof(struct task_struct, thread.fpu.fpr[18].val64[(0)])	 # */
#define THREAD_FPR19_LS64 928 /* offsetof(struct task_struct, thread.fpu.fpr[19].val64[(0)])	 # */
#define THREAD_FPR20_LS64 936 /* offsetof(struct task_struct, thread.fpu.fpr[20].val64[(0)])	 # */
#define THREAD_FPR21_LS64 944 /* offsetof(struct task_struct, thread.fpu.fpr[21].val64[(0)])	 # */
#define THREAD_FPR22_LS64 952 /* offsetof(struct task_struct, thread.fpu.fpr[22].val64[(0)])	 # */
#define THREAD_FPR23_LS64 960 /* offsetof(struct task_struct, thread.fpu.fpr[23].val64[(0)])	 # */
#define THREAD_FPR24_LS64 968 /* offsetof(struct task_struct, thread.fpu.fpr[24].val64[(0)])	 # */
#define THREAD_FPR25_LS64 976 /* offsetof(struct task_struct, thread.fpu.fpr[25].val64[(0)])	 # */
#define THREAD_FPR26_LS64 984 /* offsetof(struct task_struct, thread.fpu.fpr[26].val64[(0)])	 # */
#define THREAD_FPR27_LS64 992 /* offsetof(struct task_struct, thread.fpu.fpr[27].val64[(0)])	 # */
#define THREAD_FPR28_LS64 1000 /* offsetof(struct task_struct, thread.fpu.fpr[28].val64[(0)])	 # */
#define THREAD_FPR29_LS64 1008 /* offsetof(struct task_struct, thread.fpu.fpr[29].val64[(0)])	 # */
#define THREAD_FPR30_LS64 1016 /* offsetof(struct task_struct, thread.fpu.fpr[30].val64[(0)])	 # */
#define THREAD_FPR31_LS64 1024 /* offsetof(struct task_struct, thread.fpu.fpr[31].val64[(0)])	 # */
#define THREAD_FCR31 1032 /* offsetof(struct task_struct, thread.fpu.fcr31)	 # */
#define THREAD_MSA_CSR 1036 /* offsetof(struct task_struct, thread.fpu.msacsr)	 # */
...
#define VCPU_ARCH_SIZE 2400 /* sizeof(struct kvm_vcpu_arch)	 # */
#define VCPU_RUN 44 /* offsetof(struct kvm_vcpu, run)	 # */
#define VCPU_HOST_ARCH 216 /* offsetof(struct kvm_vcpu, arch)	 # */
